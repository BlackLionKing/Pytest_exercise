...
class Test_cala(object):
    ...
    # 兼容pytest.ini 将yml文件路径改为绝对路径
    add_subtraction_yaml = yaml.load(open('/Users/zcsy/Documents/Pytest_exercise/data/add_subtraction_cala.yml'), Loader=yaml.Loader)

    # 乘除法共用一套测试数据 乘法成功的数据case 除法则失败
    division_ride_yaml = yaml.load(open('/Users/zcsy/Documents/Pytest_exercise/data/division_ride_cala.yml'), Loader=yaml.Loader)
